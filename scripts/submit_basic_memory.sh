#!/bin/bash
#SBATCH -J var_basic_memory
#SBATCH -p gpu
#SBATCH -N 1
#SBATCH -n 16
#SBATCH --gres=gpu:4
#SBATCH -o /share/home/u2415063010/myproject/var_convmemcode/logs/basic_memory.txt
...
torchrun --nproc_per_node=4 --master_port=18560 train.py \
	--data_path=./dataset_v3_patches \
	--exp_name=basic_memory_d12 \
	--bs=16 \
	--depth=12 \
	--ep=250 \
	--fp16=1 \
